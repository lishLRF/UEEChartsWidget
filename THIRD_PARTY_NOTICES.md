...
This plugin redistributes the following unmodified browser distributions for offline use.
...
- Source: https://registry.npmjs.org/echarts-gl/-/echarts-gl-2.1.0.tgz
- License: BSD 3-Clause License
- License text: `ThirdPartyLicenses/echarts-gl-2.1.0.txt`
